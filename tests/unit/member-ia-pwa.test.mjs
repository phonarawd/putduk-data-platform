...
assert.match(index, /putduk-boot-v48-member-ia9-pwa-off-perf-fomo-catalog-bg-cloudflare-production-20260924/);
assert.match(index, /assets\\/app-ia9\\.js/);
assert.match(adminIndex, /assets\\/app-ia9\\.js/);
