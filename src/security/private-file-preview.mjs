...
export function normalizePreviewPurpose(purpose) {
...
export function parsePrivatePreviewPath(path) {
...
export function assertPrivatePreviewAccess(path, purpose, roles = []) {
  ...
  if (parsed.family === 'kyc') {
    ...
    return { ok: true, family: 'kyc', memberId: parsed.memberId };
  }
  ...
  if (parsed.family === 'finance') {
    ...
    return { ok: true, family: 'finance', memberId: parsed.memberId };
  }
