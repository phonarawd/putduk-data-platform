...
const OVERLAY_SURFACE_CSS = `.modal-backdrop[data-stable="1"],
...
function overlaySurfaceKey(state = {}) {
...
function overlayBodyToken(state = {}, helpers = {}) {
...
function escapeOverlayAttr(value) {
  return String(value ?? '')
    .replace(/&/g, '&amp;')
    .replace(/"/g, '&quot;')
    .replace(/</g, '&lt;')
...
function stampOverlayMarkup(html, key, body, escapeHtml = escapeOverlayAttr) {
...
function overlayPaintPlan(input = {}) {
